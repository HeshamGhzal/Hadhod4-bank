...
int main()
{
	...
	period1.start_date.month = 9;
	period1.start_date.year = 2022;

	period1.end_date.day = 1;
	period1.end_date.month = 12;
	period1.end_date.year = 2022;

	period2.start_date.day = 1;
	period2.start_date.month = 4;
	period2.start_date.year = 2022;

	period2.end_date.day = 1;
	period2.end_date.month = 9;
	period2.end_date.year = 2022;


	if (is_overlapped_tow_date_periods(period1, period2))
	{
		cout << "\nThese periods are over lapped.\n";
	}
	else
	{
		cout << "\nNo overlap between these tow periods.\n";
	}
