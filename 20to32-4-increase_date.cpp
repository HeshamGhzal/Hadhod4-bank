...
sdate add_X_day_to_date(sdate& date, int x);
sdate add_one_week_to_date(sdate& date);
sdate add_X_week_to_date(sdate& date, int x);
sdate add_one_month_to_date(sdate& date);
sdate add_X_month_to_date(sdate& date, int x);
sdate add_one_year_to_date(sdate& date);
sdate add_x_year_to_date(sdate& date, int x);
sdate add_x_year_to_date_faster(sdate& date, int x);
sdate add_one_decode_to_date(sdate& date);
sdate add_x_decode_to_date(sdate& date, int x);
sdate add_x_decode_to_date_faster(sdate& date, int x);
sdate add_one_century_to_date(sdate& date);
sdate add_one_millennium_to_date(sdate& date);
...
int main()
{
	...
	add_one_day_to_date(date1);
	cout << "after adding_one_day_to_date          " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_X_day_to_date(date1, 10);
	cout << "after adding_10_day_to_date           " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_week_to_date(date1);
	cout << "after adding_one_week_to_date         " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_X_week_to_date(date1, 10);
	cout << "after adding_10_week_to_date          " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_month_to_date(date1);
	cout << "after adding_one_month_to_date        " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_X_month_to_date(date1, 5);
	cout << "after adding_5_month_to_date          " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_year_to_date(date1);
	cout << "after adding_one_year_to_date         " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_x_year_to_date(date1, 10);
	cout << "after adding_10_year_to_date          " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_x_year_to_date_faster(date1, 10);
	cout << "after adding_10_year_to_date_faster   " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_decode_to_date(date1);
	cout << "after adding_one_decode_to_date       " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_x_decode_to_date(date1, 10);
	cout << "after adding_10_decode_to_date        " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_x_decode_to_date_faster(date1, 10);
	cout << "after adding_10_decode_to_date_faster " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_century_to_date(date1);
	cout << "after adding_one_century_to_date      " << date1.day << "/" << date1.month << "/" << date1.year << endl;
	add_one_millennium_to_date(date1);
	cout << "after adding_one_millennium_to_date   " << date1.day << "/" << date1.month << "/" << date1.year << endl;
...
sdate add_one_week_to_date(sdate& date)
{
	add_X_day_to_date(date, 7);
	return date;
}
sdate add_X_week_to_date(sdate& date, int x)
{
	add_X_day_to_date(date, 7 * x);
	return date;
}
sdate add_one_month_to_date(sdate& date)
{
